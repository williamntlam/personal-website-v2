    ...
    <div className={`${geistSans.className} font-sans min-h-screen bg-white dark:bg-black`}>
      ...
      <section className="min-h-screen flex items-center justify-center px-8 py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-12 text-center max-w-2xl mx-auto">
            I share my thoughts, experiences, and insights from my journey as a student and developer. 
            Explore my collection of personal reflections and life lessons.
          </p>
          <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-sm text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-2xl mx-auto">
              A space for personal reflections, life lessons, and the occasional insight from my journey as a student and developer. 
              Welcome to my collection of thoughts and experiences.
            </p>
            <a 
              href="https://william-n-lam.netlify.app/" 
              target="_blank" 
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
              ...
              <a href="https://www.linkedin.com/in/william-nhut-lam-b3a8a2213/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">
                linkedin.com/in/william-nhut-lam
              </a>
            </div>
